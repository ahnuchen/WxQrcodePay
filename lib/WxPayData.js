...
WxPayDataBase.prototype = {
    ...
    ToUrlParams: function () {
        ...
        for (key in this.keys) {
            var val = this.values[key];
            if (k != "sign" && val != "" && typeof val != "object") {
                buff += key + "=" + val + "&";
            }
        }
        buff = buff.trim();
...
function WxPayResults() {
    WxPayDataBase.call(this);
}
util.inherits(WxPayResults, WxPayDataBase);
WxPayResults.prototype = {
    /**
     *
     * 检测签名
     */
 ...
 *
 */
function WxPayNotifyReply() {
    WxPayDataBase.call(this);
}
util.inherits(WxPayNotifyReply, WxPayDataBase);
WxPayNotifyReply.prototype = {
    /**
...
util.inherits(WxPayUnifiedOrder, WxPayDataBase);

WxPayUnifiedOrder.prototype = {
    /**
     * 设置键值数组
     */
    setKeys:function () {
...
exports.WxPayResults = WxPayResults;
exports.WxPayUnifiedOrder = WxPayUnifiedOrder;
